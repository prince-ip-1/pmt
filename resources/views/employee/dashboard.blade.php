    ...
    <div class="page-wrapper">
        ...
        <div class="page-body">
            ...
            <div class="row">
             ...
             @include('includes.dashboard_message')
                            ...
                            <div class="row m-b-25">
                                ...
                                <div class="col-auto p-r-0">
                                    ...
                                    <div class="u-img">
                                        ...
                                        <img src="{{URL::to('dist\assets\images\breadcrumb-bg.jpg')}}" alt="user image" class="img-radius cover-img">

                                        <img src="{{URL::to('dist\assets\images\avatar-2.jpg')}}" alt="user image" class="img-radius profile-img">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="b-none">
                                                            ...
                                                            <img src="{{URL::to('dist\assets\images\avatar-2.jpg')}}" alt="user image" class="img-radius img-40 align-top m-r-15">
                            ...
                            <div class="col-sm-4 bg-c-lite-green user-profile">
                                ...
                                <div class="card-block text-center text-white">
                                    ...
                                    <div class="m-b-25">
                                        ...
                                        <img src="{{URL::to('dist\assets\images\avatar-4.jpg')}}" class="img-radius" alt="User-Profile-Image">
