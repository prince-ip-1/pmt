...
<div class="main-body">
  <!--  <input type="hidden" id="table_name" value="system_information">
   <input type="hidden" id="action" value="{{URL::to('/admin/add_system_information')}}">
   <input type="hidden" id="system_id" name="id" value="">
 -->
   <input type="hidden" id="table_name" value="mobile">
   <input type="hidden" id="action" value="{{URL::to('/admin/add_system_information')}}">
   <input type="hidden" id="mobile_id" name="id" value="">
      ...
      <div class="page-body">
         <div class="card">
            ...
            @endphp
               ...
               <button type="button" class="btn btn-primary  btn-round waves-effect waves-light waves-effect md-trigger" data-modal="modal-4"
                        ...
                        @foreach($data['system_information'] as $k=>$row)
                         <tr id="table_tr_{{$row->id}}">
                          ...
                          <td>
                           ...
                           <td>
                               <span>{{dateformat($row->purchase_date)}}</span>
                           </td>
                            @if(isset($permission[9]->delete) && $permission[9]->delete == 1 || getDepartment() == 1)
...
<div class="animation-model">
   <div class="md-modal md-effect-1" id="modal-2">
      <div class="md-content">
         <h3>System Information Details</h3>
         <div>
            @include('admin.system_information.system_info_details')           
         </div>
      </div>
   </div>
...
<div class="animation-model">
   <div class="md-modal md-effect-1" id="modal-4">
      <div class="md-content">
         ...
         <div>
            @include('admin.system_information.update_details')           
         </div>
      </div>
   </div>
   <div class="md-overlay"></div>
