<form id="category_form" method="post" action="/" novalidate="">
   ...
   <div class="modal-footer">
      <button type="submit" class="btn btn-primary btn-round save_category m-b-0">Submit</button>
      <button type="button" class="btn btn-primary waves-effect close_category_model md-close btn-round">Close</button>
   </div>
</form>