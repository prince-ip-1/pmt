...
<input type="hidden" id="table_name" value="expense_category">
<input type="hidden" id="action" value="{{URL::to('add_expense_category')}}">
<div class="main-body">
            ...
            <div class="card-block">
               <div class="dt-responsive table-responsive">
                  <table id="alt-pg-dt" class="table table-striped table-bordered nowrap">
                     ...
                     <tbody>
                        @foreach($data['category'] as $k=>$row)
                        <tr id="table_tr_{{$row->id}}"  class="view_tr_{{$row->id}}">
                           ...
                           <td>
                              <span class="tabledit-span category_{{$row->id}} tabledit-span_{{$row->id}}">{{$row->category_name}}</span>
                               <input class="form-control tabledit-input_{{$row->id}}" type="text" name="category_name" id="category_name_{{$row->id}}" value="{{$row->category_name}}" style="display:none">
                           </td>
