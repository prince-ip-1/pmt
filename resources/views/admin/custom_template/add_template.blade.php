                ...
                <div class="card-block">
                    <div class="row">
                                ...
                                <div class="col-sm-6 form-group ">
                                    ...
                                    <input name="template_title" id="template_title" type="text" class=" form-control" placeholder="">
                    ...
                    <div class="row">
                                ...
                                <div class="col-sm-6 form-group ">
                                    ...
                                    <input name="email_subject" id="email_subject" type="text" class=" form-control" placeholder="">
                                    <span class="error_message text-danger"></span>
                                 </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12 form-group ">
                                    <label class="block">Template Description<span class="error">*</span></label>
                                     <textarea name="template_description" id="template_summernote"></textarea> 
