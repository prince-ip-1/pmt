 <input type="hidden" name="leave_id" value="" id="edit_leave_id">
<form id="main2" method="post" action="/" novalidate="" >
   ...
   <div class="modal-footer">
      <button type="submit" id="submitChatButton" class="btn btn-primary btn-round  m-b-0">Submit</button>
