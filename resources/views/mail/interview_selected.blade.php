                  ...
                  <tr>
                    <td style="text-align: left;">
                      <div style="">
                          ...
                          <p>
                            Thank you for taking the time to interview for the {{$data['technology']}} position. We enjoyed getting to know you. We have completed all of our interviews.
                          </p>
                          <p>I'm pleased to inform you that we would like to offer you the {{$data['technology']}} position. We believe your Knowledge and strong skills will be an asset to our company. Your starting salary will be {{$data['technology']}} with an anticipated start date of {{$data['technology']}}.
                          </p>
                          <p>Please respond to this email by {{$data['technology']}} for confirm your joining .I look forward to hearing from you.
                          </p>
