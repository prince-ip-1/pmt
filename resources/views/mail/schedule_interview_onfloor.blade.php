                  ...
                  <tr>
                    <td style="text-align: left;">
                      <div style="">
                          ...
                          <p>As per our telephonic conversation, we have scheduled your interview for the position of {{$data['technology']}}  in our organization. Please find the schedule details below:</p>
                          <p><b>Date:</b> {{$data['date']}}<br/>
                          <b>Time:</b> {{$data['time']}}<br/>
                          <b>Day:</b>  {{$data['day']}}<br/> 
                          <b>Address: </b>1203, Elite Business Park, Opp. Shapath Hexa,<br/>
                          Nr. Kargil crossroad, Sola, Ahmedabad, Gujarat, India - 380060</p>

                          <p>Please revert us with your confirmation. </p>
